...
character*(*), parameter :: fpath = 'dir_atomnl2_meta//'
character*(*), parameter :: fpath1 = 'fw_data_new//'
...
!
!     ASCII input files
open (20, file = fpath//'nl3i_all_ascii')  
open (21, file = fpath//'nl3a_all_ascii')  
open (22, file = fpath//'nl3g_all_ascii')  

open (23, file = fpath1//'nl3info', status = 'unknown')  !NOTE: fpath1
...
!i=3407016
!print*,xlam(i-1),gf(i-1),id(i-1)
!print*,xlam(i),gf(i),id(i)
!print*,xlam(i+1),gf(i+1),id(i+1)
...
!     Binary output files
open (30, file = fpath1//'nl3i_all', form = 'unformatted', status = 'unknown')
open (31, file = fpath1//'nl3a_all', form = 'unformatted', status = 'unknown')
open (32, file = fpath1//'nl3g_all', form = 'unformatted', status = 'unknown')

open (33, file = fpath1//'nl3info_all', status = 'unknown')  
