pro netnew,file,nl,rate1,rate2,rate3
rate1_11=dblarr(47)
rate1_2 =dblarr(47)
rate1_3=dblarr(47)
rate1_4=dblarr(47)
...
for j=0,6 do begin
for i=0,46 do begin
if rate1(j,i) gt 0 then begin
rate1(j,i)=alog10(rate1(j,i))
endif else begin
rate1(j,i)=-alog10(-rate1(j,i))
endelse

if rate2(j,i) gt 0 then begin
rate2(j,i)=alog10(rate2(j,i))
endif else begin
rate2(j,i)=-alog10(-rate2(j,i))
endelse

if rate3(j,i) gt 0 then begin
rate3(j,i)=alog10(rate3(j,i))
endif else begin
rate3(j,i)=-alog10(-rate3(j,i))
endelse
