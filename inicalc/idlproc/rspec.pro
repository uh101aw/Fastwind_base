...
print,' no of data points (paco-style) = ',ndata
...
endwhile
 ...
 print,' no of data points (keith-style) = ',ndata
 
 lam=reform(data(0,*))
 spec=reform(data(1,*))
 return

 endif else if (size(str))(1) eq 4 then begin
; Klaus Ruebke style
...
endwhile
 ...
 print,' no of data points (Ruebke-style) = ',ndata
...
print,' no of data points (artemio-style)= ',ndata
