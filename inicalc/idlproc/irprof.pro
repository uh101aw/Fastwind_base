...
if nspec ne 21 and nspec ne 8 and nspec ne 1 then begin
  print,'Wrong layout!'
  return
endif
...
lines=['PGAMMA','PBETA','PALPHA','BR12','BR11','BR10','BRGAMMA','BRBETA','BRALPHA', $
       'PF10','PF9','PFGAMMA','HEI170','HEI205','HEI211', $
       'HEII57','HEII611','HEII713','HEII712','HEII218','HEII67']

;titles=['Br12','Br11','Br10','Br_gamma','Pf_gamma','Br_alpha', $
;	'HeI1.70','HeI2.05','HeI2.11','HeI6678','HeII1.69','HeII2.18']
titles=['Pa_gamma','Pa_beta','Pa_alpha','Br12','Br11','Br10','Br_gamma','Br_beta','Br_alpha', $
        'Pf_10','Pf_9','Pf_gamma','HeI1.70','HeI2.05','HeI2.11', $
	'HeII5_7','HeII6_11','HeII7_13','HeII1.69','HeII2.18','HEII6_7']

xranges=fltarr(2,21)
xranges[*,3]=[1.63,1.65]
xranges[*,4]=[1.67,1.69]
xranges[*,5]=[1.726,1.746]
xranges[*,6]=[2.15,2.18]
xranges[*,8]=[4.02,4.08]
xranges[*,11]=[3.7,3.78]
xranges[*,12]=[1.695,1.706]
xranges[*,13]=[2.05,2.065]
xranges[*,14]=[2.107,2.118]
xranges[*,18]=[1.688,1.697]
xranges[*,19]=[2.183,2.195]
