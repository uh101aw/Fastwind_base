pro niiiprof,mods,star,ext=extin, $
    ...
    restn=restn,lamc1=lamc1,profc1=profc1	      
...
if keyword_set(trip) then begin
  if trip eq 1 then begin
  lines=['NIII4634','NIII4640']
  titles=['NIII4634','NIII4640']
  pline=[4634,4640.6]
  !p.multi=[0,1,2]
endif else if trip eq 2 then begin
  lines=['NIIItrip']
  titles=['NIII4634/40/42']
  pline=[4634.]
endif else begin
  stop,' wrong triplet option'
endelse
endif
...
if keyword_set(restn) then begin
lines=['NIII6445','NIII6451','NIII6454','NIII6463','NIII6468','NIII6479']
titles=['NIII6445','NIII6451','NIII6454','NIII6463','NIII6468','NIII6479']
pline=[6445,6451,6454,6463,6468,6479]
!p.multi=[0,2,3]
endif
