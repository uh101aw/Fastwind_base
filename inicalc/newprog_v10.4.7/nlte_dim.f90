...
!  DIMENSIONS FROM FILE  A10HHeCNO.dat                   
 
 
!    NUMBER OF ATOMS
INTEGER(I4B), PARAMETER :: ID_ATOMS =  5
 
!    NUMBER OF FREQUENCIES (coarse mesh, modify in case)
INTEGER(I4B), PARAMETER :: ID_FREC1 =  2200
...
!    NUMBER OF IONS
INTEGER(I4B), PARAMETER :: ID_IONES =  20
 
!    NUMBER OF L + K LEVELS
INTEGER(I4B), PARAMETER :: ID_LLEVS =   644
...
INTEGER(I4B), PARAMETER :: ID_RCBBT = 19043
 
!    NUMBER OF RBX + CBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBXT =     1
 
!    NUMBER OF CBS + CBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_CBSFT =   683
 
!    NUMBER OF RBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RBFTR =   656
 
!    NUMBER OF RFF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RFFTR =    15
 
!    NUMBER OF TOTAL TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTRAN = 20397
 
!   NUMBER OF RBB + RBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTTRD =  5141
 
!    NUMBER OF DATA
INTEGER(I4B), PARAMETER :: ID_NDATA = 66759
