...
!                    CONVOLVE, but apacitl(lso OP_RBFSETUP, used by formula 20), &
...
LOGICAL, PARAMETER :: OPT_OIII_ITER =.FALSE.
...
! in case, this statement might be removed
