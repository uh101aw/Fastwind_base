! version 1.7 (Oct. 2020) compatible with gfortran
!
...
!INTEGER(I4B), PARAMETER :: ND1 = 91              !suggested if IR should be calculated 
!INTEGER(I4B), PARAMETER :: NP1 = 96              !p-rays
!INTEGER(I4B), PARAMETER :: ND1 = 61              !suggested if IR should be calculated 
!INTEGER(I4B), PARAMETER :: NP1 = 66              !p-rays
!INTEGER(I4B), PARAMETER :: ND1 = 53              !suggested if IR should be calculated 
...
INTEGER(I4B), PARAMETER :: NP1 = 77 !high resol. p-rays for high resol. of photosphere
