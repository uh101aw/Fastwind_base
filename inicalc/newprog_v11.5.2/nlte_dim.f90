...
!  DIMENSIONS FROM FILE  A10HHeO.dat                     
 
 
!    NUMBER OF ATOMS
INTEGER(I4B), PARAMETER :: ID_ATOMS =  3
 
!    NUMBER OF FREQUENCIES (coarse mesh, modify in case)
INTEGER(I4B), PARAMETER :: ID_FREC1 =  1800
...
!    NUMBER OF IONS
INTEGER(I4B), PARAMETER :: ID_IONES =  11
 
!    NUMBER OF L + K LEVELS
INTEGER(I4B), PARAMETER :: ID_LLEVS =   313
...
INTEGER(I4B), PARAMETER :: ID_RCBBT =  9610
 
!    NUMBER OF RBX + CBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RCBXT =     1
 
!    NUMBER OF CBS + CBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_CBSFT =   351
 
!    NUMBER OF RBF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RBFTR =   327
 
!    NUMBER OF RFF TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_RFFTR =     8
 
!    NUMBER OF TOTAL TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTRAN = 10296
 
!   NUMBER OF RBB + RBX TRANSITIONS
INTEGER(I4B), PARAMETER :: ID_NTTRD =  2931
 
!    NUMBER OF DATA
INTEGER(I4B), PARAMETER :: ID_NDATA = 30190
...
!    NUMBER OF P-RAYS
INTEGER(I4B), PARAMETER :: ID_NPOIN = 77
